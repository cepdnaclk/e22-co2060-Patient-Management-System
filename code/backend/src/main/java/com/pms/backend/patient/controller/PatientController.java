...
public class PatientController {
    ...
    @PostMapping
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasRole('ADMIN') or hasRole('MANAGEMENT') or hasRole('PATIENT') or hasRole('RECEPTIONIST')")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasRole('ADMIN') or hasRole('MANAGEMENT') or hasRole('PATIENT') or hasRole('DOCTOR') or hasRole('RECEPTIONIST') or hasRole('NURSE')")
