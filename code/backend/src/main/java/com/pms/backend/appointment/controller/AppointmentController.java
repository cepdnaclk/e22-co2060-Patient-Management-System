...
public class AppointmentController {
    ...
    @PostMapping
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasRole('PATIENT') or hasRole('ADMIN')")
    ...
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasRole('ADMIN') or hasRole('PATIENT') or hasRole('DOCTOR')")
