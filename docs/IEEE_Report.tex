...
\begin{figure}[H]
  \centering
  % Uncomment and replace with your actual architecture diagram:
  % \includegraphics[width=\columnwidth]{images/architecture_diagram.png}
  \fbox{\parbox{0.9\columnwidth}{\centering\vspace{2cm}\textit{[System Architecture Diagram]}\\\textit{Insert architecture diagram here}\vspace{2cm}}}
